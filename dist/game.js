...
class Pong {
    ...
    update_ball() {
        ...
        // !!!! la balle augmente de vitesse ici donc calcul fausse pour le this.ball.time_ia_in_frame !!!
        // donc parfois la paddle IA n'intercepte pas la balle mais pas grave car l'erreur fait humaine
        // (sinon a changer ici)
        // PAS SURE FINALEMENT car la paddle s'arrette net, donc soit erreur de calcul soit prob de marge je sais pas 
